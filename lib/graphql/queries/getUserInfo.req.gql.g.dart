...
part of 'getUserInfo.req.gql.dart';
...
class _$GGetUserInfoReq extends GGetUserInfoReq {
  ...
  factory _$GGetUserInfoReq([void Function(GGetUserInfoReqBuilder)? updates]) =>
      (new GGetUserInfoReqBuilder()..update(updates)).build();
  ...
  _$GGetUserInfoReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GGetUserInfoReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, 'GGetUserInfoReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GGetUserInfoReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetUserInfoReq')
          ..add('vars', vars)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GGetUserInfoReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
