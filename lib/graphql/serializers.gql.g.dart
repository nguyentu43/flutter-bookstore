...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(GAddRatingData.serializer)
      ..add(GAddRatingData_result.serializer)
      ..add(GAddRatingReq.serializer)
      ..add(GAddRatingVars.serializer)
      ..add(GAddWishlistData.serializer)
      ..add(GAddWishlistReq.serializer)
      ..add(GAddWishlistVars.serializer)
      ..add(GAuthorData.serializer)
      ..add(GCartItemData.serializer)
      ..add(GCategoryData.serializer)
      ..add(GCheckoutData.serializer)
      ..add(GCheckoutData_order.serializer)
      ...
      ..add(GGetPaymentCodeData.serializer)
      ..add(GGetPaymentCodeReq.serializer)
      ..add(GGetPaymentCodeVars.serializer)
      ...
      ..add(GGetWishlistData.serializer)
      ..add(GGetWishlistData_products.serializer)
      ..add(GGetWishlistData_products_images.serializer)
      ..add(GGetWishlistReq.serializer)
      ..add(GGetWishlistVars.serializer)
      ..add(GLoginData.serializer)
      ..add(GLoginReq.serializer)
      ..add(GLoginVars.serializer)
      ..add(GLoginWithProviderData.serializer)
      ..add(GLoginWithProviderReq.serializer)
      ..add(GLoginWithProviderVars.serializer)
      ...
      ..add(GRemoveRatingData.serializer)
      ..add(GRemoveRatingReq.serializer)
      ..add(GRemoveRatingVars.serializer)
      ..add(GRemoveWishlistData.serializer)
      ..add(GRemoveWishlistReq.serializer)
      ..add(GRemoveWishlistVars.serializer)
      ..add(GUpdateRatingData.serializer)
      ..add(GUpdateRatingData_updateRating.serializer)
      ..add(GUpdateRatingReq.serializer)
      ..add(GUpdateRatingVars.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<GGetWishlistData_products>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(GGetWishlistData_products_images)]),
          () => new ListBuilder<GGetWishlistData_products_images>())
      ..addBuilderFactory(
